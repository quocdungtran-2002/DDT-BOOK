...
<script src="../view/js/bootstrap-select.js"></script>
<script src="../view/js/inewsticker.js"></script>
<script src="../view/js/bootsnav.js."></script>
<script src="../view/js/images-loded.min.js"></script>
<script src="../view/js/isotope.min.js"></script>
<script src="../view/js/owl.carousel.min.js"></script>
<script src="../view/js/baguetteBox.min.js"></script>
<script src="../view/js/form-validator.min.js"></script>
<script src="../view/js/contact-form-script.js"></script>
